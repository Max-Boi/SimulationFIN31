...
{
    private static readonly IReadOnlyDictionary<string, ParentsRelationshipQuality> ParentsRelationshipMap = new Dictionary<string, ParentsRelationshipQuality>
    {
    ...
    private static readonly IReadOnlyDictionary<string, SocialEnergyLevel> SocialEnergyMap = new Dictionary<string, SocialEnergyLevel>
    {
    ...
    /// </summary>
    public static string ToGermanString(this ParentsRelationshipQuality value) => value switch
    {
    ...
    /// </summary>
    public static string ToGermanString(this SocialEnergyLevel value) => value switch
    {
    ...
    /// </summary>
    public static string ToGermanString(this GenderType value) => value switch
    {

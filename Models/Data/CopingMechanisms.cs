...
public static class CopingMechanism
{
    ...
    [
        ...
        new()
        {
            ...
            IsTraumatic = false,
            Type = CopingType.Functional,
            Trigger = new CopingTrigger(moodThreshold: -35, belongingThreshold: 30),
            IsHabitForming = true,
            StressImpact = -20,
            MoodImpact = 15,
        ...
        new()
        {
            ...
            IsTraumatic = false,
            Type = CopingType.Functional,
            Trigger = new CopingTrigger(moodThreshold: -45),
            IsHabitForming = true,
            StressImpact = -12,
            MoodImpact = 14,
        ...
        new()
        {
            ...
            IsTraumatic = false,
            Type = CopingType.Dysfunctional,
            Trigger = new CopingTrigger(80, -50),
            IsHabitForming = true,
            StressImpact = -20,
            MoodImpact = 8,
        ...
        new()
        {
            ...
            IsTraumatic = false,
            Type = CopingType.Dysfunctional,
            Trigger = new CopingTrigger(65, -35),
            IsHabitForming = true,
            StressImpact = -10,
            MoodImpact = 5,
            SocialBelongingImpact = -3,
        ...
        new()
        {
            ...
            IsTraumatic = false,
            Type = CopingType.Functional,
            Trigger = new CopingTrigger(moodThreshold: -40, stressThreshold: 65),
            IsHabitForming = true,
            StressImpact = -8,
            MoodImpact = 6,
            SocialBelongingImpact = 0,
